...
export default {
    ...
    methods: {
        ...
        async submitForm() {
            ...
            const myContent = tinymceUpdate.get("description_value_update").getContent();
            ...
            try {
                ...
                tinymceUpdate.activeEditor.setContent("");
                this.$refs.pond_thumbnail_update.removeFiles();
                this.$refs.pond_banner_update.removeFiles();
                    ...
                    category.name }}</label>
                        ...
                        <div class="col-span-2" id="sample">
                            <label for="description"
                                ...
                                do artigo</label>
                            <tinymceUpdate :plugins="myPluginsUpdate" :toolbar="myToolbarUpdate" :init="myInitUpdate" id="description_value_update"
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <file-pond ref="pond_thumbnail_update" class-name="my-pond"
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <file-pond ref="pond_banner_update" class-name="my-pond"
