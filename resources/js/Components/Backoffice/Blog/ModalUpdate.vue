...
export default {
    ...
    methods: {
        ...
        // isCategorySelected(categoryName, categories) {
        //     const categoryNames = categoryName.split(',').map(word => word.trim());
        //     const selected = categories.some(category => categoryNames.includes(category.name));
