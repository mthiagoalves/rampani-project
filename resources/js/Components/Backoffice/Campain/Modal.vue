        ...
        async submitForm() {
            ...
            try {
                ...
                Swal.fire({
                    icon: "error",
                    title: "Erro!",
                    text: 'Algo aconteceu na criação da campanha 😔',
                });
            }
        }
    },
                ...
                <form class="p-4 md:p-5" @submit.prevent="submitForm">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input type="text" id="name" ref="name" name="name"
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="category"
                                ...
                                campanha</label>
                            <select id="category" ref="type" name="type" required
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus-standard border-standard block w-full p-2.5">
                        ...
                        <div class="col-span-2 sm:col-span-1 m-auto">
                            <label for="order"
                                ...
                                exibição</label>
                            <input type="number" id="order" ref="order" name="order"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus-standard border-standard block w-full p-2.5"
                        ...
                        <div class="col-span-2 sm:col-span-2">
                            ...
                            <file-pond name="thumbnail" ref="pond_banner_pc" class-name="my-pond"
                        ...
                        <div class="col-span-2 sm:col-span-2">
                            ...
                            <file-pond name="banner" ref="pond_banner_mobile" class-name="my-pond"
                                ...
                                allow-multiple="true" accepted-file-types="image/jpeg, image/png"
                                v-on:init="handleFilePondInit" aria-required="true" />
                        </div>
                    </div>
                    <div class="text-end">
                        <button type="submit"
